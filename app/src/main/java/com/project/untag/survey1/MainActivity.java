...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edTanggal,edNomor,edIdPel,edProvinsi,edKabupatenKota,edNama,edAlamat,edKecamatan,edWilayah,edJumlah,edCospi,edAmpere,edStandM,edLat,edLng,edJumlahMCB;
    ImageView imgPhoto;
    ImageButton btnSave,btnSearch;
